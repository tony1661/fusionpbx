<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "208bdaf9-b2ff-483b-af86-a0afe1c198cb";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "avaya_j189_wallpaper_filename";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "The filename that should be used as the default wallpaper";
		$y++;
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "4748b66c-ea81-4ceb-b2b1-a3c956d7376b";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "avaya_j189_secondary_wallpaper_filename";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "The filename that should be used as the default wallpaper for the secondary screen";
		$y++;
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "c93308e7-b0bf-4147-bc48-4a8f3f7c46c3";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "320 x 240 pixels max. JPG only. Max file size is 256KB";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "ed70d43e-462b-4979-a0cd-1de6ed2ffd83";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "320 x 240 pixels max. JPG only. Max file size is 256KB";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "bf59665e-9264-4b57-976e-cde10ad891f0";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
